        ...
        <div role="tabpanel" class="row tab-product-list tabpanel" >
            <div class="col-md-12">
                ...
                <div class="tab-content">
                	<form method="post" action="<?php if(isset($WEB_ROOT))  echo $WEB_ROOT ; ?>transferException/purchaseDiff">
                            ...
                            <table class="table table-striped table-bordered ">
								...
								?>
                            		<tr>
                            			...
                            			<td class="product_cell"><?php echo $loading_bill_item['finish_case_num']?></td>
                                        ...
                                        <td class="product_cell">
                                        	...
                                        	<a class="btn btn-primary" target="_blank" href="<?php if(isset($WEB_ROOT))  echo $WEB_ROOT ; ?>purchaseIn/index?bol_sn=<?php echo $loading_bill_item['bol_sn']?>&facility_id=<?php echo $loading_bill_item['facility_id']?>">入库详情</a>
                                        	<?php }?>
                                        </td>
