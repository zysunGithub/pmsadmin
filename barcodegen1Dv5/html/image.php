...
if (!file_exists('barcodegen1Dv5/html/config' . DIRECTORY_SEPARATOR . $code . '.php')) {
    showError();
}

include_once('barcodegen1Dv5/html/config' . DIRECTORY_SEPARATOR . $code . '.php');

$class_dir = 'barcodegen1Dv5/class';
